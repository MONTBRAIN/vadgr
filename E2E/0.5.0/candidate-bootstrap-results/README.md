# Bootstrap boundary observations
...
observations for the no-secret boundary checks. No signed product result is
claimed. Native Windows checks use Windows Python and Windows PowerShell.
Fixture paths in transcripts use the label `FIXTURE`.
