...
| O: shared offline, accessibility and cleanup cells | partial development: the complete Windows x64 Narrator matrix and cleanup are recorded; protected isolated-account offline lifecycle remains owed | partial development: native focus, VoiceOver speech, state matrix and isolated fixture cleanup ran; offline snapshot, final product cleanup and protected screen-reader-setting restoration remain owed | not run: host qualification is incomplete | not run: host qualification is incomplete |
...
| macOS Intel/Apple Silicon | M01, M02, F01, M03 through M06, O1, O2, C1 | partial: Apple Silicon unsigned installed configuration, phone pairing/watch and accessibility observations are filed; signed candidate, Intel, Tailscale pairing, remaining lifecycle assertions, final cleanup and protected VoiceOver-setting restoration are owed |
