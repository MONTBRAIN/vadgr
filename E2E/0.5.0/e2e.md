...
| O: shared offline, accessibility and cleanup cells | partial development: the complete Windows x64 Narrator matrix is recorded; protected isolated-account offline lifecycle and final cleanup remain owed | partial: Installer accessibility and safe interim cleanup ran; installed accessibility, offline and final artifact removal remain owed | not run: host qualification is incomplete | not run: host qualification is incomplete |

## Completion ledger

| host | cells | result |
|---|---:|---|
| Windows x64/arm64 | W01, W02, F01, W03 through W10, O1, O2, C1 | partial: x64 unsigned F01/W05 and the full Narrator matrix are filed; signed candidate, arm64, signed fault slices, protected isolated-account offline/purge work and final cleanup remain owed |
