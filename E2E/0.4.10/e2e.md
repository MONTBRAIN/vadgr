...
| overall | not run: no live cell has run | **pass**: every cell and all three independent closing passes pass | **pass**: all 50 cells pass, including the handset part and the traversal spike, and all three independent closing passes pass against one frozen head | **pass**: every cell and all three independent closing passes pass |
